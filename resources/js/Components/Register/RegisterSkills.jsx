...
const RegisterSkills = ({ skillCategories, handlePrevious, handleNext, selectedSkills, handleAddSkill, handleRemoveSkill, allowToViewSkillsExperience }) => {
    ...
    return (
        <div className="max-w-3xl mx-auto">
            ...
            <div className="flex justify-between">
                ...
                <button
                    onClick={handleNext}
                    disabled={!allowToViewSkillsExperience()}
